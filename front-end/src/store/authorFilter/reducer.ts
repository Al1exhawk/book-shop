...
export const AuthorFilterReducer: Reducer<AuthorFilterState, ActionTemplate> = (state: AuthorFilterState = initialState, action: ActionTemplate): AuthorFilterState => {
    switch(action.type) {
